...
from opensora3.dataset.t2v_datasets import T2V_dataset
from opensora3.dataset.inpaint_dataset import Inpaint_dataset
from opensora3.models.causalvideovae import ae_norm, ae_denorm
from opensora3.dataset.transform import ToTensorVideo, TemporalRandomCrop, MaxHWResizeVideo, CenterCropResizeVideo, LongSideResizeVideo, SpatialStrideCropVideo, NormalizeVideo, ToTensorAfterResize
...
if __name__ == "__main__":
    ...
    from opensora3.dataset.t2v_datasets import dataset_prog
    from opensora3.utils.dataset_utils import LengthGroupedSampler, Collate
