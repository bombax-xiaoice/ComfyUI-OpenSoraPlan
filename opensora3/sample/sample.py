...
if __name__ == "__main__":
    ...
    if args.num_frames != 1 and args.enhance_video is not None:
        from opensora3.sample.VEnhancer.enhance_a_video import VEnhancer
