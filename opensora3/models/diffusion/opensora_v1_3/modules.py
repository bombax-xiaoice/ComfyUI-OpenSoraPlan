...
try:
    import torch_npu
    from opensora3.npu_config import npu_config, set_run_dtype
    from opensora3.acceleration.parallel_states import get_sequence_parallel_state, hccl_info as xccl_info
    from opensora3.acceleration.communications import all_to_all_SBH
except:
    torch_npu = None
    npu_config = None
    set_run_dtype = None
    from opensora3.utils.parallel_states import get_sequence_parallel_state, nccl_info as xccl_info
    from opensora3.utils.communications import all_to_all_SBH
