...
try:
    ...
    from opensora3.acceleration.parallel_states import initialize_sequence_parallel_state, hccl_info
except:
    torch_npu = None
    npu_config = None
    from opensora3.utils.parallel_states import initialize_sequence_parallel_state, nccl_info
    pass

from opensora3.utils.utils import set_seed
from opensora3.models.causalvideovae import ae_stride_config, ae_wrapper
from opensora3.sample.pipeline_opensora import OpenSoraPipeline
from opensora3.sample.pipeline_inpaint import OpenSoraInpaintPipeline
...
def prepare_pipeline(args, dtype, device):
    ...
    if args.version == 'v1_3':
        ...
        if args.model_type == 'inpaint' or args.model_type == 'i2v':
            ...
            from opensora3.models.diffusion.opensora_v1_5.modeling_opensora import OpenSoraT2V_v1_5
