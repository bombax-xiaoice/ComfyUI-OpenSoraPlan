...
from opensora2.models.diffusion.udit.modeling_udit import UDiTT2V
...
from opensora2.sample.pipeline_inpaint_sp import OpenSoraInpaintPipeline

import imageio
try:
    import torch_npu
    from opensora2.npu_config import npu_config
    from opensora2.acceleration.parallel_states import initialize_sequence_parallel_state, hccl_info
except:
    torch_npu = None
    npu_config = None
    from opensora2.utils.parallel_states import initialize_sequence_parallel_state, nccl_info
    pass
import time
...
from opensora2.dataset.transform import ToTensorVideo, CenterCropResizeVideo, TemporalRandomCrop, LongSideResizeVideo, SpatialStrideCropVideo
import numpy as np
