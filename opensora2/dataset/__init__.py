...
from opensora2.dataset.t2v_datasets import T2V_dataset
from opensora2.dataset.inpaint_datasets import Inpaint_dataset
from opensora2.dataset.transform import ToTensorVideo, TemporalRandomCrop, RandomHorizontalFlipVideo, CenterCropResizeVideo, LongSideResizeVideo, SpatialStrideCropVideo
from opensora2.models.causalvideovae import ae_norm, ae_denorm
...
if __name__ == "__main__":
    ...
    from opensora2.dataset.t2v_datasets import dataset_prog
    import random
