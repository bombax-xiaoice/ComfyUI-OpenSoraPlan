...
import re
from opensora2.adaptor.zp_manager import zp_manager
...
class NPUConfig:
    ...
    def __init__(self):
        ...
        if self.on_npu:
            ...
            from opensora2.adaptor.utils import all_gather_dp_groups, all_gather_into_tensor_dp_groups
            utils.all_gather_dp_groups = all_gather_dp_groups

            import deepspeed.runtime.bf16_optimizer as bf16_optimizer
            from opensora2.adaptor.bf16_optimizer import BF16_Optimizer
            self.replace_methods(bf16_optimizer.BF16_Optimizer, BF16_Optimizer)

            from opensora2.adaptor.stage_1_and_2 import DeepSpeedZeroOptimizer
            ...
            from opensora2.adaptor.engine import DeepSpeedEngine
