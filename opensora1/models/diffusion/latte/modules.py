...
from opensora1.models.diffusion.utils.pos_embed import get_2d_sincos_pos_embed, RoPE1D, RoPE2D, LinearScalingRoPE2D, LinearScalingRoPE1D
...
class Attention(nn.Module):
    ...
    def set_use_memory_efficient_attention_xformers(
        ...
        """
        try:
            from diffusers import LORA_ATTENTION_PROCESSORS #deprecated after diffusers==0.26.0
